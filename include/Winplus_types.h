 ...
 *
 * Wrong usage:
 *     i32 timestamp = 1674938400000; // ERROR: Unix timestamp in ms exceeds
 * range, use i64
 *
 *     i32 bigData = 3000000000;     // ERROR: Value exceeds i32 range
 *
 *     i32 money = -5000000000;      // ERROR: Large financial values should use
 * i64
 */
typedef int32_t i32;
 ...
 *
 * Wrong usage:
 *     i64 smallValue = 42;              // ERROR: Wasteful for small numbers,
 * use i8/i16
 *
 ...
 *
 * Wrong usage:
 *     c8 nonAscii = 0x80;       // ERROR: Non-ASCII characters may not be
 * supported
 *
 ...
 *
 *     iptr nonPointer = 42;      // ERROR: Use integer types for non-pointer
 * values
 */
 ...
 *
 *     uptr nonPointer = 42;      // ERROR: Use integer types for non-pointer
 * values
 */
 ...
 *
 * Wrong usage:
 *     wc16 nonUnicode = 0x80;   // ERROR: Non-Unicode characters may not be
 * supported
 *
 ...
 *
 * Wrong usage:
 *     c16 nonUnicode = 0x80;   // ERROR: Non-Unicode characters may not be
 * supported
 *
 ...
 *
 * Wrong usage:
 *     c32 nonUnicode = 0x80;   // ERROR: Non-Unicode characters may not be
 * supported
 *
 ...
 *
 * Wrong usage:
 *     l32 timestamp = 1674938400000; // ERROR: Unix timestamp in ms exceeds
 * range, use i64
 *
 *     l32 bigData = 3000000000;     // ERROR: Value exceeds l32 range
 *
 *     l32 money = -5000000000;      // ERROR: Large financial values should use
 * i64
 */
typedef long l32;
 ...
 *
 * Wrong usage:
 *     ll64 smallValue = 42;              // ERROR: Wasteful for small numbers,
 * use i8/i16
 *
 *     ll64 tinyCounter = 100;            // ERROR: Excessive for simple
 * counters
 *
 ...
 *
 *     ull64 value = 5000000000;   // ERROR: Missing ULL suffix for large
 * literals
 */
